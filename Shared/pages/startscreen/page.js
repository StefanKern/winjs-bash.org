...
(function () {
    ...
    WinJS.UI.Pages.define("/pages/startscreen/page.html", {
        ...
        ready: function (element, options) {
            ...
            $('#ratemyapp').click(function () {
                var uriToLaunch = "ms-windows-store:REVIEW?PFN=" + appname;
            ...
            $('#about').click(function () {
                WinJS.Navigation.navigate("/pages/aboutpage/page.html");
            });
        }
    });
})();
